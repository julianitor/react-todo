...
var TodoItem = React.createClass({displayName: "TodoItem",
  render: function() {
    ...
    var todo = this.props[0];
    var caption = _.get(todo, 'caption');
    return (React.createElement("li", {className: (_.get(todo, 'done')? 'done' : '', )
                    onClick: sender('item:toggle', todo)}, 
             React.createElement("input", {type: "checkbox"}), ",", 
             React.createElement("label", {caption: true}), 
...
var TodoList = React.createClass({displayName: "TodoList",
  render: function() {
    ...
    var itemViews = _.map(function(item){
...
var TodoToggleButtons = React.createClass({displayName: "TodoToggleButtons",
  ...
  return (React.createElement("span", {className: "completed"}, ",", 
           React.createElement("a", {className: isActive(filter, 'all'), href: "#", 
                   onClick: sender('set:filter', 'all')}, 
             React.createElement("span", null, " 'All '")
           ), 
           React.createElement("a", {className: isActive(filter, 'active'), href: "#"}, 
                   "onClick=sender('set:filter', 'active')>", 
             React.createElement("span", null, " 'Active '")
           ), 
           React.createElement("a", {className: isActive(filter, 'done'), href: "#", 
